angular.module('app.messageRoute', [])
  .controller('messageDetailController', function ($q, $stateParams, authService,messages_services) {

    var _self = this;
    var firebaseRef = firebase.database().ref();

    _self.userId = $stateParams.uid;
    _self.myId = authService.getUid;
    _self.content = "";

    firebaseRef.child('users/'+ _self.userId);
    ...
    _self.sendMessage = function (text) {
      messages_services.keepSendFirst(text,_self.userId).then(function (data) {
        _self.content = "";
      }, function (error) {
